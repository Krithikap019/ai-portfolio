...
└─────────────────────────┘   └─────────────────────────────┘
  ...
  <Link href="/projects/churn_prediction" style={{ textDecoration: "none" }}>
  ...
  <Link href="/projects/covid_detection" style={{ textDecoration: "none", textAlign: "right" }}>
    ...
    <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.3rem", fontWeight: 600, color: "#0d1f18" }}>COVID Severity Detection</p>
  </Link>
</div>
    </main>
  );
