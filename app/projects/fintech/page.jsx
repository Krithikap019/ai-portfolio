...
{`750K Customers (3 BK Segments: 150 · 200 · 250)
  ...
  <Link href="/projects/snowflake" style={{ textDecoration: "none" }}>
    ...
    <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.3rem", fontWeight: 600, color: "#0d1f18" }}>Scalable Data Processing with Snowflake</p>
  </Link>
  <Link href="/projects/nptb" style={{ textDecoration: "none", textAlign: "right" }}>
    ...
    <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.3rem", fontWeight: 600, color: "#0d1f18" }}>Pentathlon – Next Product to Buy</p>
  </Link>
</div>
    </main>
  );
