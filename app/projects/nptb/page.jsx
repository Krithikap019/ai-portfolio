...
{`600K+ Customer–Email Observations (randomized)
  ...
  <Link href="/projects/fintech" style={{ textDecoration: "none" }}>
    ...
    <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.3rem", fontWeight: 600, color: "#0d1f18" }}>FiTech – Credit Card Design</p>
  </Link>
  <Link href="/projects/ai_conversation" style={{ textDecoration: "none", textAlign: "right" }}>
    ...
    <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.3rem", fontWeight: 600, color: "#0d1f18" }}>AI Conversation Intelligence</p>
  </Link>
</div>
    </main>
  );
