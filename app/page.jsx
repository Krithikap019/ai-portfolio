    ...
    <main style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", background: "#f4f8f6", minHeight: "100vh", color: "#0d1f18" }}>
      ...
      <section style={{ display: "grid", gridTemplateColumns: "1.6fr 1fr", gap: "2rem", alignItems: "center", padding: "5rem 3.5rem 4rem" }}>
        <div>
          ...
          <h1 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(5rem, 8vw, 9.5rem)", lineHeight: "1", fontWeight: 600, letterSpacing: "-0.02em", marginBottom: "0.3rem", marginTop: "0.6rem"  }}>
            Krithika Suwarna
          </h1>
...
{/* Education */}
      <section style={{ padding: "5rem 3.5rem", borderTop: "1px solid rgba(10,124,82,0.15)" }}>
        <p style={{ fontSize: "0.7rem", fontWeight: 700, letterSpacing: "0.15em", textTransform: "uppercase", color: "#0a7c52", marginBottom: "0.6rem" }}>Education</p>
...
<section id="contact" style={{ background: "#0d1f18", padding: "3.5rem 3.5rem" }}>
  ...
  <a href="https://github.com/Krithikap019" target="_blank"
  ...
  <a href="mailto:krithikap019@gmail.com"
    onMouseEnter={(e) => e.currentTarget.style.background = "#064d33"}
    onMouseLeave={(e) => e.currentTarget.style.background = "#0a7c52"}
    style={{ display: "flex", alignItems: "center", gap: "1rem", padding: "1.2rem 1.5rem", background: "#0a7c52", border: "1px solid #0a7c52", borderRadius: "8px", textDecoration: "none", color: "#fff", transition: "background 0.2s" }}>
