  ...
  return (
    <main style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", background: "#f4f8f6", minHeight: "100vh", color: "#0d1f18" }}>
      ...
      <section id="experience" style={{ padding: "5rem 3.5rem", borderTop: "1px solid rgba(10,124,82,0.15)" }}>
        ...
        <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "3rem", fontWeight: 700, marginBottom: "3rem" }}>The Professional <em style={{ color: "#0a7c52", fontStyle: "italic" }}>Journey</em></h2>
        <ExperienceTimeline />
      </section>
