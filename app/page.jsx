...
<section id="contact" style={{ background: "#0d1f18", padding: "3.5rem 3.5rem" }}>
  ...
  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "1rem" }}>
    <a href="https://github.com/Krithikap019" target="_blank" style={{ display: "flex", alignItems: "center", gap: "1rem", padding: "1.2rem 1.5rem", background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: "8px", textDecoration: "none", color: "#fff" }}>
      ...
      <div>
        <p style={{ fontSize: "0.6rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "rgba(255,255,255,0.5)", marginBottom: "0.2rem" }}>GitHub</p>
        <p style={{ fontSize: "0.85rem", fontWeight: 600 }}>github.com/Krithikap019</p>
      </div>
      <span style={{ marginLeft: "auto", color: "rgba(255,255,255,0.4)" }}>→</span>
    </a>

    <a href="https://linkedin.com/in/krithika-suwarna" target="_blank" style={{ display: "flex", alignItems: "center", gap: "1rem", padding: "1.2rem 1.5rem", background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: "8px", textDecoration: "none", color: "#fff" }}>
      <div style={{ width: "36px", height: "36px", background: "rgba(255,255,255,0.1)", borderRadius: "8px", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
      </div>
      <div>
        <p style={{ fontSize: "0.6rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "rgba(255,255,255,0.5)", marginBottom: "0.2rem" }}>LinkedIn</p>
        <p style={{ fontSize: "0.85rem", fontWeight: 600 }}>linkedin.com/in/krithika-suwarna</p>
      </div>
      <span style={{ marginLeft: "auto", color: "rgba(255,255,255,0.4)" }}>→</span>
    </a>

    <a href="mailto:krithikap019@gmail.com" style={{ display: "flex", alignItems: "center", gap: "1rem", padding: "1.2rem 1.5rem", background: "#0a7c52", border: "1px solid #0a7c52", borderRadius: "8px", textDecoration: "none", color: "#fff" }}>
      ...
      <div>
        <p style={{ fontSize: "0.6rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "rgba(255,255,255,0.7)", marginBottom: "0.2rem" }}>Email</p>
        <p style={{ fontSize: "0.85rem", fontWeight: 600 }}>krithikap019@gmail.com</p>
      </div>
      <span style={{ marginLeft: "auto", color: "rgba(255,255,255,0.7)" }}>→</span>
    </a>
  </div>
</section>
